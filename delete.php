        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form  method="post" action="deleteProcessing.php">
                        <div class="alert alert-danger">
                            
                            <p>Are you sure you want to delete your account ?</p>
                            <p>
                                <input type="submit" name="delete" value="Yes" class="btn btn-danger" id='btnDelete'>
                                <a href="profile.php" class="btn btn-secondary ml-2">No</a>
                            </p>
                        </div>
                    </form>
                </div>
