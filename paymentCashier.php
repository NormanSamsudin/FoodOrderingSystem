...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <!--<a class="btn-book-a-table" href="#book-a-table">Cancel</a>-->
  ...
  <section id="why-us" class="why-us section-bg">
      ...
      <div class="panel-body-payment2">
        <i class='bi bi-check2-all' style='font-size:60px;color:grey'></i>
      </div>

        <div class="row justify-content-md-center">
            <div class="col-xl-4" data-aos="fade-up" data-aos-delay="200">
              <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                <h4>Proceed to cashier to complete your order.</h4>
                <h4> Thank you !</h4>
                  <form action="">
                      <a class="btn-book-a-table" style=' color: white; background-color: red ;border-radius: 12px;padding: 8px;' href="paymentDone.php" >Done</a>
                  </form>
