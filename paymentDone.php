...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <!--<a class="btn-book-a-table" href="paymentBank.php">Cancel</a>-->
  ...
  <section id="why-us" class="why-us section-bg">
      ...
      <div class="panel-body-payment2">
        <i class='bi bi-check2-all' style='font-size:60px;color:green'></i>
      </div>

        <div class="row justify-content-md-center">
            <div class="col-xl-4" data-aos="fade-up" data-aos-delay="200">
              <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                <h4>Your order goes straight to our kitchen. We will serve you just in time.</h4>
                <h4> Thank you !</h4>
                  <a class="btn-book-a-table" style=' color: white; background-color: red ;border-radius: 12px;padding: 8px;' href="index.php" >Done</a>
              </div>
            </div><!-- End Icon Box -->
        </div>
