...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <!--<a class="btn-book-a-table" href="payment.php">Cancel</a>-->
  ...
  <section id="why-us" class="why-us section-bg">
      ...
      <div class="panel-body-payment">
        <h2 class="title">Please scan our QR code.</h2>
        ...
        <div class="row justify-content-md-center">
            <div class="col-xl-6" data-aos="fade-up" data-aos-delay="200">
              <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                ...
                <br></br>
                <a>1. Screenshot the QR.</a>
                <a>2. Click "Scan from gallery".</a>
                <a>3. Upload the payment screenshot.</a>
                <br></br>
                  <a class="btn-book-a-table" style=' color: white; background-color: red ;border-radius: 12px;padding: 8px;' href="paymentDone.php" >Upload </a>
              </div>
            </div><!-- End Icon Box -->
        </div>
